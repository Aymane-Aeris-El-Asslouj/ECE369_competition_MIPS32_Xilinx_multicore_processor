...
module aeris_ram (DOA, DOB,
   ...
   input wire [ADDRB_WIDTH-1:0] ADDRB;
   input wire CLKA;
   input wire CLKB;
   input wire [WRITE_WIDTH_A-1:0] DIA;
   input wire [WRITE_WIDTH_B-1:0] DIB;
   input wire ENA;
   input wire ENB;
   input wire REGCEA;
   input wire REGCEB;
   input wire RSTA;
   input wire RSTB;
   input wire [WEA_WIDTH-1:0] WEA;
   input wire [WEB_WIDTH-1:0] WEB;
...
WEB; 
   ...
   generate 
            ...
            if (BRAM_SIZE == "36Kb") begin : bram36_tdp_bl
